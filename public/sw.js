// ElevenEleven service worker — Web Push receiver.
// Shows a notification when the server pushes one, and focuses/opens the app on tap.
...
self.addEventListener("push", (event) => {
  ...
  const title = payload.title || "ElevenEleven";
  const options = {
    body: payload.body || "",
    icon: "/icon-192.png",
    badge: "/icon-192.png",
