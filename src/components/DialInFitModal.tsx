...
// The paper, at varying strength, knocking the photograph back behind the type.
const scrim = (a: number) => `rgba(247,244,239,${a})`;
    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          onClick={onClose}
          style={{
            position: "fixed", inset: 0, background: C.scrim, zIndex: 9000,
        ...
        >
          <motion.div
            ...
            style={{
              ...
              borderRadius: RADIUS, overflowX: "hidden", background: C.paper,
            }}
          >
            ...
            <div style={{ position: "relative", zIndex: 1, padding: "92px 26px 28px" }}>
              <h2 style={display(38)}>Dial in your fit</h2>
              <p style={{ ...body(13.5, C.inkSoft), margin: "14px 0 26px", maxWidth: "36ch" }}>
                {partial
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                {asking.map(cat => (
                  <div key={cat.label}>
                    <p style={{ ...meta(10.5, C.ink), fontWeight: 700, marginBottom: 10 }}>
                      {cat.label}
                    </p>
                      ...
                      {cat.options.map(opt => {
                        ...
                        return (
                          <button
                            ...
                            style={{
                              padding: "9px 15px", borderRadius: RADIUS,
                              border: `1px solid ${active ? C.burgundy : C.rule}`,
                              background: active ? C.burgundy : "rgba(255,255,255,0.55)",
                              color: active ? "#FFFFFF" : C.inkSoft, fontFamily: SANS, fontSize: 11.5,
              ...
              <button
                ...
                style={{
                  ...meta(12, "#FFFFFF"),
                  width: "100%", marginTop: 30, padding: "16px 0", borderRadius: RADIUS,
                  border: `1px solid ${C.burgundy}`, background: C.burgundy,
              ...
              {auto && (
                <p style={{ ...meta(9.5, C.muted), textAlign: "center", margin: "10px 0 0" }}>
